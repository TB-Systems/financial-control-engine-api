...
func (a *annualTransaction) ReadIDs(ctx context.Context, userID uuid.UUID) (commonsmodels.ResponseList[uuid.UUID], errors.ApiError) {
	ids, err := a.repository.ReadAnnualTransactionsIDs(ctx, userID)
