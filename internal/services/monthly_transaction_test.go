...
func (m *MonthlyTransactionRepositoryMock) ReadMonthlyTransactionsIDs(ctx context.Context, params commonsmodels.PaginatedParamsWithMonthYear) ([]uuid.UUID, error) {
	if m.IDsError != nil {
