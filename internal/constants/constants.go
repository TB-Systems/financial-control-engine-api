...
const (
	...
	MonthlyTransactionAlreadyExistsMsg     = "MONTHLY_TRANSACTION_ALREADY_EXISTS"
	AnnualTransactionAlreadyExistsMsg      = "ANNUAL_TRANSACTION_ALREADY_EXISTS"
	InstallmentTransactionAlreadyExistsMsg = "INSTALLMENT_TRANSACTION_ALREADY_EXISTS"
)
